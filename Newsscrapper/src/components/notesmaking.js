      ...
      <div className="container  mx-auto">
        ...
        <div className="flex gap-9 mb-8 relative w-60">
          <div className="input_holder h-40 w-40  ">
            <textarea
              className="  bg-cyan-500 shadow-lg shadow-cyan-500/50 rounded-lg bg-sky-100 w-full h-full p-3 resize-none text-red-700 shadow-cyan-500/50  box-shadow"
              value={input}
          ...
          <div>
            <button
              className=" absolute right-0 top-16 ml-5  px-3 py-3    rounded-xl bg-cyan-500 shadow-lg shadow-cyan-500/50   text-black bg-cyan-300 rounded-lg hover:bg-cyan-100 "
              onClick={saveToDo}
            >
              Add
            </button>
        ...
        <div className=" flex flex-wrap gap-10 ml-7 mr-2  w-full ">
          {toDos.map((el) => (
            <div
              key={el._id}
              className="relative p-1 border rounded-lg h-90 w-40 bg-gray-100"
            >
              <ToDo
                text={el.toDo}
                id={el._id}
